        ...
        <div className="p-2 sm:p-3 bg-white rounded-xl w-full">
            <form action="" className='flex flex-col lg:flex-row gap-4 sm:gap-6 md:gap-8 lg:gap-13.25'>
                ...
                <div className='relative mb-4 sm:mb-6 lg:mb-8 mx-auto lg:mx-0 flex-shrink-0'>
                    <img src={profile} alt="profile" className="w-30 h-30 sm:w-28 sm:h-28 md:w-30 md:h-30 xl:w-36 xl:h-36 rounded-full object-cover" />
                    <button 
                        type="button"
                        className='cursor-pointer absolute top-20 sm:top-18 md:top-20 xl:top-24 right-0 w-7 h-7 sm:w-7.5 sm:h-7.5 lg:w-8 lg:h-8 bg-[#1814F3] rounded-full flex items-center justify-center hover:bg-[#1410cf] transition-colors'
                    >
